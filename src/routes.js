...
const routes = [
  ...
  { path: '/dashboard', name: 'Ana Sayfa', element: dashboard },
  { path: '/theme', name: 'Theme', element: Colors, exact: true },
  { path: '/theme/colors', name: 'Colors', element: Colors },
  { path: '/theme/typography', name: 'Typography', element: Typography },
  { path: '/base', name: 'Hizmet Ekleme', element: Cards, exact: true },
  ...
  { path: '/charts', name: 'Firma Ekleme', element: Charts },
  ...
  { path: '/icons', exact: true, name: 'Personeller', element: CoreUIIcons },
